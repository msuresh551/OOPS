...
namespace oopsconcepts
{
    ...
    public class Teachers
    {
        ...
        public static void Main()
        {
            ...
            //In method overriding Base class reference variable pointing to a child class object,will invoke the overriding 
            //In the child class.
            //In method hiding base class reference variable pointing to a Child object, will invoke the Hiden method in the base class
